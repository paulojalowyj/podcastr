...
export function Player() {
    ...
    const { clearPlayerState, episodeList, currentEpisodeIndex, isPlaying, togglePlay, toggleLoop, setPlayingState, playNext, playPrevious, hasPrevious, hasNext, isLooping, toggleShuffle, isShuffling } = usePlayer()
